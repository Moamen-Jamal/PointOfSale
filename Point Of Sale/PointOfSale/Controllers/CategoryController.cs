...
namespace PointOfSale.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        public CategoryController(CategoryService _CategoryService, ILogger<CategoryController> logger)
        {
        ...
        //[HttpGet(Name = "GetLatestCategories")]
        //public ResultViewModel<IEnumerable<CategoryViewModel>> GetLatestCategories(int index = 0)
        //{
        //    ResultViewModel<IEnumerable<CategoryViewModel>> result
        //        = new ResultViewModel<IEnumerable<CategoryViewModel>>();
        //    try
        //    {
        //        var Categories = CategoryService.GetLatest(index);
        //        result.Successed = true;
        //        result.Data = Categories;
        //    }
        //    catch (Exception ex)
